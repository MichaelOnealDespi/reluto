...
public class MostMonth {

    private TextView recipeTitle;
    private boolean isFoodTechSelected;  // true for Food Technologists, false for Recipes
    private boolean isMonthlySelected;  // true for Monthly filter, false for other time filters

    // Constructor with the necessary flags
    public MostMonth(TextView recipeTitle, boolean isFoodTechSelected, boolean isMonthlySelected) {
        this.recipeTitle = recipeTitle;
        this.isFoodTechSelected = isFoodTechSelected;
        this.isMonthlySelected = isMonthlySelected;
    }
